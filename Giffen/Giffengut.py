...
class Giffen(GraphFromData):
    ...
    "num_rects": 50,
        ...
        def construct(self):
            ...
            dot1.scale(0.75)
            line1group = VGroup(dottedlinehorz1,dottedlinevert1)
            #
            ...
            dot2.scale(0.75)
            line2group = VGroup(dottedlinehorz2,dottedlinevert2)
            #
            ...
            dot3.scale(0.75)
            line3group = VGroup(dottedlinehorz3,dottedlinevert3)
            #
            ...
            dot4.scale(0.75)
            line4group = VGroup(dottedlinehorz4,dottedlinevert4)
            #
            ...
            dot5.scale(0.75)
            line5group = VGroup(dottedlinehorz5,dottedlinevert5)
            #
            ...
            dot6.scale(0.75)
            line6group = VGroup(dottedlinehorz6,dottedlinevert6)
            #
            ...
            dot7.scale(0.75)
            line7group = VGroup(dottedlinehorz7,dottedlinevert7)
            #
